...
class ForecastWeatherModel {
  ...
  factory ForecastWeatherModel.fromJson(Map<String, dynamic> json) => ForecastWeatherModel(
    ...
    cnt: json["cnt"],
    forecastWeather: List<ForecastWeather>.from(json["forecastWeather"].map((x) => ForecastWeather.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "message": message,
    "cnt": cnt,
    "forecastWeather": List<dynamic>.from(forecastWeather.map((x) => x.toJson())),
    "city": city.toJson(),
  };
}
